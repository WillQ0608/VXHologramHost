...
private IEnumerator PrintDialogue()
{
    while (currentDialogueIndex < dialogueList.Count)
    {
        ...
        if (line.isQuestion)
        {
            line.isGoing = true; // Set isGoing to true when isQuestion is true
            line.isEnd = true; // Set isEnd to true when isQuestion is true
    ...
    private IEnumerator TypeText(string text)
    {
        ...
        if(!dialogueList[currentDialogueIndex].isGoing)
            DialogueStop();
